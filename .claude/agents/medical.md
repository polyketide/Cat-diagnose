...
**背景**:曾在一份知识库的参考文献表里,把标题写成中文概括(如「Almendros A, et al. **香港 444 例队列**」),又把英文标题截短(实际是 "Feline extranodal lymphoma: **response to chemotherapy and survival in** 110 cats",写成 "…: 110 cats")。**这些标题不存在。** 任何人照着引用都会引错——而参考文献表的唯一用途就是被引用。
